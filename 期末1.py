...
choices = ['聯電: 2023.4.17 至 2025.4.16','金融期貨FXF:2020.3.2至2025.4.14','台積電期貨CDF:2022.3.2至2025.4.14']
...
if choice == choices[0] :         ##'台積電: 2022.1.1 至 2024.4.9':
    df_original = pd.read_pickle('future_KBar_CCF.pkl')
    product_name = '聯電'
...
if choice == choices[2] :                              ##'小台指期貨2024.12到期: 2023.12 至 2024.4.11':
    df_original = pd.read_pickle('台積電期貨CDF:2022.3.2至2025.4.14')
